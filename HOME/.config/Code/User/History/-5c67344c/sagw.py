...
def translate_audio_file(audio_file_path, target_language, speech_key, speech_region, source_language="en-US"):
    ...
    def recognized_cb(evt):
        ...
        if evt.result.reason == speechsdk.ResultReason.TranslatedSpeech:
            ...
            print("Segment translated: {}".format(evt.result.translations[target_language]))
    ...
    print("Full recognized text: {}".format(full_recognized_text))
    print("Full translated text: {}".format(full_translated_text))
