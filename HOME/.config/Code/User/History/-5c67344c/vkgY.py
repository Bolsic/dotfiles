...
def translate_audio_file(audio_file_path, target_language, speech_key, speech_region, source_language="en-US", recognised_text_queue=None, translated_text_queue=None, done_event=None):
    ...
    translation_config.set_property(speechsdk.PropertyId.Speech_SegmentationSilenceTimeoutMs, "2000")
...
def translate_live_audio(speech_key, speech_region, source_language, target_language,
    ...
    translation_config.set_property(speechsdk.PropertyId.Speech_SegmentationStrategy, "Semantic")
    recognizer.set_property(speechsdk.PropertyId.Speech_SegmentationStrategy, "Semantic")
