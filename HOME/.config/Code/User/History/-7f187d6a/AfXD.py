...
def synthesize_voice(input_text, language, output_path):
    ...
    speech_config.speech_synthesis_voice_name = "sr-Latn-RS-NicholasNeural"
...
# List all files in the directory
    ...
    # Display the files with index numbers
    ...
    try:
        ...
        if 1 <= choice <= len(files):
            ...
            audio_file_path = os.path.join(directory_path, selected_file)
        else:
    ...
    synthesize_voice(translated_text, language="sr-RS", output_path=output_path)
