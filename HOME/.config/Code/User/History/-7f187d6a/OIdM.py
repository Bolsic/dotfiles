...
def make_output_dir(input_path):
    ...
    output_dir = input_dir.replace("Original-Audio", "Test-Output")
...
def pick_language_interface():
    ...
    try:
        ...
        if 1 <= choice <= 4:
            languages = ["en-US", "sr-Latn", "fr-FR", "de-DE"]
...
if __name__ == "__main__":
    ...
    directory_path = "/home/basic/Projects/Vavilon/Test-Audio"
    ...
    translated_text = translate_text(input_text=transcription, source_language=input_language, target_language=selected_language)
    print(f"Translation: \n{translated_text}\n\n")

    print("Synthesizing voice...")
    synthesize_voice(translated_text, language=selected_language, output_path=output_path)
