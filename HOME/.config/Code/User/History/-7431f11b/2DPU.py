...
def create_output_audio_path(input_audio_path):   
    ...
    print("Input audio directory:", input_audio_dir)
    input_audio_dir = os.path.basename(input_audio_dir) 
    print("Input audio directory:", input_audio_dir)
    output_dir = os.path.join(os.path.dirname(input_audio_path), "Translated-Audio")
...
input_audio_path = "/home/basic/Projects/Vavilon/Original-Audio/Djokic-Intro.wav"
...
def main():
    # Prompt user for input audio file path
    audio_path = input("Enter the path to the input audio file: ").strip()
    ...
    transcribed_text, detected_language = transcribe_audio_to_text(audio_path)
    ...
    output_audio_path = "translated_speech.wav"
